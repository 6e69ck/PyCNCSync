...
��� **[View Latest Builds](https://github.com/6e69ck/PyCNCSync/actions)**
...
- **Behavior**: Local folder → Google Drive (one-way push)
...
- **Behavior**: Google Drive → Local folder (one-way pull)
